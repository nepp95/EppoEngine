...
namespace Eppo
{
		...
		: m_Specification(specification)
	{
		...
		m_ImageInfo.Allocation = Allocator::AllocateImage(m_ImageInfo.Image, imageCreateInfo, VMA_MEMORY_USAGE_GPU_ONLY);
		...
		Image::TransitionImage(commandBuffer, m_ImageInfo.Image, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL);
	...
	void Image::TransitionImage(VkCommandBuffer commandBuffer, VkImage image, VkImageLayout srcLayout, VkImageLayout dstLayout)
	{
	...
	VkImageAspectFlags Image::GetImageAspectFlags(VkImageLayout layout)
	{
		switch (layout)
		{
			case VK_IMAGE_LAYOUT_UNDEFINED:		return VK_IMAGE_ASPECT_NONE;
	...
	{
		uint64_t size = m_Specification.Width * m_Specification.Height * 4;
