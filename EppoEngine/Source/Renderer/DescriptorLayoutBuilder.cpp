...
namespace Eppo
{
	void DescriptorLayoutBuilder::AddBinding(uint32_t binding, VkDescriptorType type, uint32_t count /*= 1*/)
	{
	...
	VkDescriptorSetLayout DescriptorLayoutBuilder::Build(VkShaderStageFlags shaderStageFlags, VkDescriptorSetLayoutCreateFlags createFlags /*= 0*/, void* pNext /*= nullptr*/)
	{
