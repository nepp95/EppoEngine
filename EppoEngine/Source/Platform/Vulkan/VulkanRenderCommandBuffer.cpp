...
namespace Eppo
{
	...
	{
		EPPO_PROFILE_FUNCTION("VulkanRenderCommandBuffer::VulkanRenderCommandBuffer");
	...
	{
		EPPO_PROFILE_FUNCTION("VulkanRenderCommandBuffer::Begin");
	...
	{
		EPPO_PROFILE_FUNCTION("VulkanRenderCommandBuffer::End");
	...
	{
		EPPO_PROFILE_FUNCTION("VulkanRenderCommandBuffer::Submit");
	...
	void VulkanRenderCommandBuffer::EndTimestampQuery(uint32_t queryIndex)
	{
		Renderer::SubmitCommand([this, queryIndex]()
		{
			Ref<VulkanContext> context = RendererContext::Get().As<VulkanContext>();
	...
	float VulkanRenderCommandBuffer::GetTimestamp(uint32_t imageIndex, uint32_t queryIndex /*= 0*/) const
	{
	...
	const PipelineStatistics& VulkanRenderCommandBuffer::GetPipelineStatistics(uint32_t imageIndex) const
	{ 
