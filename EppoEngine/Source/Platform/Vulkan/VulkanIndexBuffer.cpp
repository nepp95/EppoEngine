...
namespace Eppo
{
	...
	{
		EPPO_MEM_WARN("Releasing index buffer {}", static_cast<void*>(this));
	...
	void VulkanIndexBuffer::SetData(const Buffer buffer)
	{
	...
	void VulkanIndexBuffer::CopyWithStagingBuffer(const Buffer buffer) const
	{
