...
namespace Eppo
{
        ...
        static auto DrawScriptField(const ScriptField& field, ScriptFieldValue& value) -> bool
        {
            ...
            switch (field.Type)
            {
                case ScriptFieldType::Float:
                    return ImGui::DragScalar(label.c_str(), ImGuiDataType_Float, data, 0.1f);
                case ScriptFieldType::Double:
                    return ImGui::InputScalar(label.c_str(), ImGuiDataType_Double, data);
                case ScriptFieldType::Bool:
                    return ImGui::Checkbox(label.c_str(), reinterpret_cast<bool*>(data));
                case ScriptFieldType::Char:
                    return ImGui::InputScalar(label.c_str(), ImGuiDataType_U16, data);
                case ScriptFieldType::Int16:
                    return ImGui::InputScalar(label.c_str(), ImGuiDataType_S16, data);
                case ScriptFieldType::Int32:
                    return ImGui::DragScalar(label.c_str(), ImGuiDataType_S32, data);
                case ScriptFieldType::Int64:
                    return ImGui::InputScalar(label.c_str(), ImGuiDataType_S64, data);
                case ScriptFieldType::Byte:
                    return ImGui::InputScalar(label.c_str(), ImGuiDataType_U8, data);
                case ScriptFieldType::UInt16:
                    return ImGui::InputScalar(label.c_str(), ImGuiDataType_U16, data);
                case ScriptFieldType::UInt32:
                    return ImGui::InputScalar(label.c_str(), ImGuiDataType_U32, data);
                case ScriptFieldType::UInt64:
                    return ImGui::InputScalar(label.c_str(), ImGuiDataType_U64, data);
                case ScriptFieldType::Vector2:
                    return ImGui::DragScalarN(label.c_str(), ImGuiDataType_Float, data, 2, 0.1f);
                case ScriptFieldType::Vector3:
                    return ImGui::DragScalarN(label.c_str(), ImGuiDataType_Float, data, 3, 0.1f);
                case ScriptFieldType::Vector4:
                    return ImGui::DragScalarN(label.c_str(), ImGuiDataType_Float, data, 4, 0.1f);
    ...
    auto PropertyPanel::RenderGui() -> void
    {
        ...
        DrawComponent<CylinderColliderComponent>(
            entity,
            [](auto& component)
            {
                ImGui::DragFloat("Radius", &component.Radius, 0.05f, 0.0f, 0.0f);
