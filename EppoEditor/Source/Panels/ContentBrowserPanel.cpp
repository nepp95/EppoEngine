...
namespace Eppo
{
    namespace
    {
        ...
        auto GetImportDirectory(const std::filesystem::path& assetsDirectory, AssetType type) -> std::filesystem::path
        {
            ...
            {
                case AssetType::Mesh:
                    return assetsDirectory / "Meshes";
                case AssetType::Scene:
                    return assetsDirectory / "Scenes";
                case AssetType::Texture:
                    return assetsDirectory / "Textures";
                case AssetType::Script:
                    return assetsDirectory / "Scripts";
                case AssetType::None:
                default:
    ...
    {
        const auto filters =
            FileDialog::BuildFilter("Importable Assets", { "gltf", "glb", "epscene", "png", "jpg", "jpeg", "tga", "bmp", "hdr" });
