...
// Focused characterization of the RenderPass/Pipeline refactor. Graphical:
// needs a real GPU (boots AppHarness). Excluded on headless CI alongside the
// other graphical suites; run locally with `ctest -R Renderer`.
SUITE(Renderer)
{
	namespace
	{
